...
public class POSInvoiceDetailAdapterFragment extends BaseAdapter {
    ...
    public POSInvoiceDetailAdapterFragment(POSInvoiceScreenFragment context, ArrayList<ReceiptDetail> posInvoiceList)
    {
        super();
...
//			rows.totalRows(Integer.toString(filteredArrayList.size()));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        POSInvoiceDetailAdapterFragment.ViewHolder holder;
        if (convertView == null) {
            holder = new POSInvoiceDetailAdapterFragment.ViewHolder();
            ...
            holder = (POSInvoiceDetailAdapterFragment.ViewHolder) convertView.getTag();
        }
