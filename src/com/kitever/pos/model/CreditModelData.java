...
public class CreditModelData {
	...
	private String orderMasterID, orderCode, orderDate, userName, billAmount,
			...
			payModeNo, chequeDate, bankName, contactName, contactID;

	public CreditModelData(String orderMasterID, String orderCode,
			...
			String chequeDate, String bankName, String contactName,String contactID) {
		super();
