...
public class ThreadCounterInbox {
    ...
    private static ServiceHitListenerwhatsup listener;
    ...
    public ThreadCounterInbox(HttpPost HttpPost, String url, int type, int ServiceName, ServiceHitListenerwhatsup listener) {

        // pass value from current class to this handler global variable value.
        ThreadCounterInbox.listener = listener;
    ...
    public interface ServiceHitListenerwhatsup {
