...
public class MicroSiteEditor extends AppCompatActivity implements View.OnClickListener {
    ...
    private String recordfilePath, latlng, function;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarSettingWithBack(this,getSupportActionBar(),"Edit ");
        setContentView(R.layout.activity_micro_site_editor);
        permissionClass = new PermissionClass(this);
        progressBar = (ProgressBar) findViewById(R.id.progressBarMicroSiteEditor);



        activityEmailEditor = (WebView) findViewById(R.id.activityMicroSiteEditor);
...
//        url = "http://172.16.4.143/Kitever/EditCompanyDetails.aspx?cname=infintiyjobs";
        url = Utils.getBaseUrlValue(this).replace("/NewService.aspx?Page=","")+"/EditCompanyDetails.aspx?cname=infintiyjobs";
...
//        activityEmailEditor.postUrl(url, EncodingUtils.getBytes(postData, "BASE64"));
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                activityEmailEditor.loadUrl("javascript:getValue" + function + "()");
                /*Toast.makeText(getBaseContext(), "Uploading completed ...", Toast.LENGTH_SHORT).show();
                Toast.makeText(getBaseContext(), function, Toast.LENGTH_SHORT).show();*/
                progressBar.setVisibility(View.GONE);
            }
        };
    }
...
//            Toast.makeText(MicroSiteEditor.this, toast, Toast.LENGTH_SHORT).show();
            function = toast;
            startGallery();
        ...
        public void openAndroidDialog() {
            AlertDialog.Builder myDialog
                    = new AlertDialog.Builder(MicroSiteEditor.this);
...
//            popupWindow.dismiss();
            return "http://nowconnect.in/" + Utils.getUserId(MicroSiteEditor.this) + "/" + MicroSiteEditor.this.str;
        }
    }
...
//        }
        if (requestCode == CAMERA_REQUEST
            ...
            try {
                ...
                file = new File(Environment.getExternalStorageDirectory(), Utils.getUserId(MicroSiteEditor.this) + "" + new Date().getTime() + ".jpg");
                if (!file.exists())
                    file.createNewFile();
    ...
    public void uploadFile(File fileName) {
        ...
        try {
            ...
            client.upload(fileName, new MicroSiteEditor.MyTransferListener(fileName.getName()));
