...
public class Templaten_new extends ArrayAdapter<String> {
	...
	public Templaten_new(AppCompatActivity context, int resource,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.templateicon.setOnClickListener(new OnClickListener() {
