...
public class CartOrderAdapter extends BaseAdapter implements Filterable {

    ArrayList<OrderDetailModelData> orderDetailsList;
    private String selectedItemType;
    private CartOrderAdapter.ItemFilter mItemFilter = new CartOrderAdapter.ItemFilter();
    private ArrayList<OrderDetailModelData> filteredArrayList = null;

    private CartOrderList context;
    private TotalRows rows;

    public CartOrderAdapter(CartOrderList context,
                            ArrayList<OrderDetailModelData> orderDetailsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CartOrderAdapter.ViewHolder holder;
        if (convertView == null) {
            holder = new CartOrderAdapter.ViewHolder();
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            convertView = inflater.inflate(R.layout.cart_order_adapter,
                    parent,false);
            ...
            holder = (CartOrderAdapter.ViewHolder) convertView.getTag();
        }
