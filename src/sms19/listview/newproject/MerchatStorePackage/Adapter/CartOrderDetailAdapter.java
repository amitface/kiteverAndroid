...
public class CartOrderDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CartOrderDetailAdapter.ViewHolder holder;
        if (convertView == null) {
            holder = new CartOrderDetailAdapter.ViewHolder();
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            convertView = inflater.inflate(R.layout.cartitem_adapter,
                    parent,false);
            ...
            holder = (CartOrderDetailAdapter.ViewHolder) convertView.getTag();
        }
