...
import sms19.listview.newproject.model.SendSmsReportTwoDayModel.ReportSmsTwo;
...
public class TwoDayAdapter extends ArrayAdapter<ReportSmsTwo> 
{
	private Context con;
    private List<ReportSmsTwo> details;
	...
	public TwoDayAdapter(Context context, int resource,List<ReportSmsTwo> objects)
	{
	...
	@Override
	public ReportSmsTwo getItem(int position) 
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		if(convertView==null)
		{
		convertView=LayoutInflater.from(con).inflate(R.layout.listsmsreports, null);
		}
...
//	    Log.w("TAG","VALUES::"+Date);
		
//		Log.w("TAG","VALUES::DATE:"+Date.substring(0,Date.indexOf("T"))+":::TIME:"+Date.substring(Date.indexOf("T")+1,Date.indexOf(".")));
