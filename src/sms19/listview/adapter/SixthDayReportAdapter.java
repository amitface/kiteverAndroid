...
import sms19.listview.newproject.model.SendSmsReportSixDayModel.ReportSmsSixth;
...
public class SixthDayReportAdapter extends ArrayAdapter<ReportSmsSixth>
{
private Context cont;
private int resource;
private List<ReportSmsSixth> details;
...
public SixthDayReportAdapter(Context context, int resource,List<ReportSmsSixth> objects)
	{
	...
	@Override
	public ReportSmsSixth getItem(int position)
	{
...
public View getView(final int position, View convertView, ViewGroup parent) 
{
	...
	{
		statisimage.setBackgroundResource(R.drawable.load);	
	}*/
	//*****************************************SET DATA
