...
import sms19.listview.newproject.model.SendSmsReportOneDayModel.ReportSmsOne;
...
public class OneDayReportAdtr extends ArrayAdapter<ReportSmsOne>
{
	private List<ReportSmsOne> details;
	...
	public OneDayReportAdtr(Context context, int resource,List<ReportSmsOne> objects) {
...
@Override
public ReportSmsOne getItem(int position)
{
	// TODO Auto-generated method stub
	return null;
}
