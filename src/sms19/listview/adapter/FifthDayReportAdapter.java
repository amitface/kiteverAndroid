...
import sms19.listview.newproject.model.SendSmsReportFiveDayModel.ReportSmsFive;
...
public class FifthDayReportAdapter extends ArrayAdapter<ReportSmsFive>
{
private Context cont;
private int resource;
private List<ReportSmsFive> details;
...
public FifthDayReportAdapter(Context context, int resource,List<ReportSmsFive> objects)
	{
	...
	@Override
	public ReportSmsFive getItem(int position)
	{
