...
public class ErrorReporter implements Thread.UncaughtExceptionHandler {
	...
	//private String[] _recipients = new String[] { "mahesh.saini@brsoftech.org" };
	private String[] _recipients = new String[] { "contactus@kitever.com" };
	private String _subject = "APK Exception Error";
