...
public class EmojiconTextView extends TextView {
	...
	private void init(AttributeSet attrs) {
		if (attrs == null) {
			...
			mTextStart = a
					.getInteger(R.styleable.Emojicon_emojiconTextStart, 0);
			mTextLength = a.getInteger(R.styleable.Emojicon_emojiconTextLength,
					-1);
	...
	public void setText(CharSequence text, BufferType type) {
		if (!TextUtils.isEmpty(text)) {
			...
			EmojiconHandler.addEmojis(getContext(), builder, mEmojiconSize,
					mTextStart, mTextLength, mUseSystemDefault);
			text = builder;
		}
