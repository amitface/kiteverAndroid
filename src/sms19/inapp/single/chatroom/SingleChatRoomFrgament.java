...
public class SingleChatRoomFrgament extends Fragment implements
        ...
        OnLongClickListener, SmsMailInterface {
    ...
    public ArrayList<Contactmodel> newbroadcastusersid;
    public ArrayList<Contactmodel> newMailbroadcastusersid;
    ...
    public static Handler ChatupdateHandler = null;
    ...
    private OnClickListener galleryClick, photoClick, videoclick, audioClick,
    ...
    public CheckBox getUser_sms_creadit() {
        return check_box;
    }


    public static SingleChatRoomFrgament newInstance(String titleName) {
        return chatFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = getActivity().getLayoutInflater().inflate(
                R.layout.single_chat_room, container, false);
        viewGlobal = view;
        ...
        if (isgroup == 2) {
            ...
            broadcastusersid = GlobalData.dbHelper
                    .getBroadcastmembersfromDB(remote_jid);
            newbroadcastusersid = new ArrayList<Contactmodel>();
            newMailbroadcastusersid = new ArrayList<Contactmodel>();
            inAppMessageActivity.getmActionBarImage().setImageResource(
                    R.drawable.icon3);
        } else if (isgroup == 1) {
            Bitmap pic = null;
            if (frndpic != null) {
...
//                .findViewById(R.id.user_email_creadit);
        ...
        email_check_box.setOnClickListener(new OnClickListener() {
...
//            credit_email_layout.setVisibility(View.GONE);
        ...
        if (isgroup == 2 && broadcastusersid.size() < 1) {
            email_check_box.setEnabled(false);
        } else if (isgroup == 0 && !GlobalData.dbHelper.isEmailAvailable(remote_jid)) {
            email_check_box.setEnabled(false);
        }
                    ...
                    if (message != null && message.trim().length() != 0) {
                        if (!check_box.isChecked()
                            ...
                            if (GlobalData.connection.isAuthenticated()) {
                                                ...
                                                public void run() {
                                                    ...
                                                    if (isgroup == 1) {
                                                        ...
                                                        if (broadcastusersid != null) {
                                                            ...
                                                            for (int i = 0; i < broadcastusersid
                                                                    .size(); i++) {
                                                            ...
                                                            if (postContactmap != null && postContactmap.size() > 0) {
                                                                String contactstring = Utils
                                                                        .makeJsonarrayfromContactmap(postContactmap);
                                                                sendBroadCastThroughApi(
                                                                        message.trim(),
                                ...
                                sendBroadCastThroughApi(message, "11",
                                        false, "0", "");
                            }
                        }
                        // loading_text.setVisibility(View.GONE);
    ...
    public void setpopUpclicks() {
        ...
        audioClick = new OnClickListener() {
            ...
            public void onClick(View v) {
				 ...
				 */
                if (permissionClass.checkPermissionForRecord()) {
                    popupWindow.dismiss();
                    RecordAudio ru = new RecordAudio(getActivity());
                    ru.ReSendalertDialog(getActivity());
                } else
                    permissionClass.requestPermissionForRecord();
        ...
        storageClick = new OnClickListener() {
    ...
    private void openFtpStorageDataList(
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                PopupWebView(ftpDatalist.get(position).getMessageBody());
            }
        });
                ...
                if (adapter.getcheckeditemcount().size() > 0
                    ...
                    for (int k = 0; k < adapter.getcheckeditemcount().size(); k++) {
                        ...
                        if (k > 0) {
                            ...
                            try {
                                org.jivesoftware.smack.packet.Message message = shareMessageBeforeUpload(
                                        dataListModel.getMessageBody(),
                                        remote_jid, dataListModel.getDataType());
                                if (GlobalData.connection.isAuthenticated()) {
                                    chatManager = GlobalData.connection.getChatManager();
                                    if (chatManager != null) {
                                        Chat chat = chatManager.createChat(remote_jid, null);
                                        chat.sendMessage(message);
                                        AddSentMessagetochatandDB(dataListModel.getDataName() + " shared", message.getPacketID(), "1",
                                                false, Utils.currentTimeStap());
                                    }
                                }
                            ...
                            try {
                                ...
                                if (GlobalData.connection.isAuthenticated()) {
                                    ...
                                    if (chatManager != null) {
                                        ...
                                        AddSentMessagetochatandDB(dataListModel.getDataName() + " shared", message.getPacketID(), "1",
                                                false, Utils.currentTimeStap());
                                    /*AddSentMessagetochatandDB(message.getBody(), message.getPacketID(),
                                            , true, msgtime);*/
                                    }
                                } else {
//                                    messageSendOffline(message, "0");
    ...
    public void showOnlineUser() {
        ...
        SingleChatRoomFrgament chatRoomFrgament = newInstance("");
...
//            email_check_box.setChecked(true);
        ...
        if (isgroup == 1) {
            ...
            if (isgroup == 2) {
                ...
                if (chatManager != null) {
                    ...
                    final int lastIndexOf = message.lastIndexOf("__");
                    final String message3 = message.substring(0, lastIndexOf);// file__http://nowconnect.in/121/Kitever_1472532377427.jpg__I
                    // file__http://nowconnect.in/121/VID-20160808-WA0001.mp4__V
                    msg2.setBody(message3);
                    msg2.addExtension(slagTag);
                        ...
                        public void run() {
                            ...
                            for (int i = 0; i < broadcastusersid.size(); i++) {
                                ...
                                try {
                                    String userId = InAppMessageActivity.USER_ID;
                                    Slacktags slagTag = new Slacktags(
                                            InAppMessageActivity.myModel
                                                    .getNumber(), userId,
                                            GlobalData.MESSAGE_TYPE_2,
                                            timeStap, userId + "_" + timeStap);
                                    org.jivesoftware.smack.packet.Message msg = new org.jivesoftware.smack.packet.Message();
                                    msg.setType(org.jivesoftware.smack.packet.Message.Type.normal);
                                    msg.setBody(message);
                                    msg.addExtension(slagTag);

                                    if (i == 0) {
                                        row_id = AddSentMessagetochatandDB(
                                                message, msg.getPacketID(),
                                                "1", false, timeStap);
                                        row_id = msg.getPacketID();
                                        Utils.printLog("rowid braodcast..."
                                                + row_id);

                                    }

                                    Slacktags slagTag2 = new Slacktags(
                                            InAppMessageActivity.myModel
                                                    .getNumber(), userId,
                                            GlobalData.MESSAGE_TYPE_2,
                                            timeStap, userId + "_" + timeStap);
                                    ...
                                    msg2.setType(org.jivesoftware.smack.packet.Message.Type.normal);
                                    msg2.setBody(message);
                                    msg2.addExtension(slagTag2);

                                    String packid = msg2.getPacketID();

                                    if (!(GlobalData.dbHelper.isOnline(jid))
                                            && (checkBoxIsCheck)) {

                                        GlobalData.dbHelper.addchatToMessagetable(
                                                jid, message,
                                                myModel.getRemote_jid(),
                                                timeStap, packid, "1", "2");// not
                                        // set
                                        GlobalData.dbHelper.updateMessageId(
                                                packid, row_id, expirytime);// update
                                        // message
                                        // id
                                        Utils.printLog("broadcastusersidofff..."
                                                + jid);
                                        ...
                                        GlobalData.dbHelper.addchatToMessagetable(
                                                ...
                                                myModel.getRemote_jid(),
                                                timeStap, packid, "1", "0");
                                        Utils.printLog("broadcastusersid..."
                                                + jid);
                                    }

                                    GlobalData.dbHelper.updateContactmsgData(
                                            jid, message, timeStap);
                                    Utils.printLog("msg.getPacketID()..."
                                            + msg2.getPacketID());
									/*
									 * MessageEventManager eventManager = new
									 * MessageEventManager(
    ...
    public String sendMessageOffline(final String message, String buddyJID)
        ...
        if (isgroup == 1) {
            ...
            if (isgroup == 2) {
                ...
                Utils.printLog("broadcast send start...");
				/*
				 * for (int i = 0; i < broadcastusersid.size(); i++) { String
				 * jid = broadcastusersid.get(i);
				 *
				 * try {
				 */
                ...
                msgpacketid = msg.getPacketID();

				/*
				 * } catch (Exception e) { // TODO Auto-generated catch block
				 * Utils.printLog("broadcast send excption...");
				 * e.printStackTrace(); } }
				 * Utils.printLog("broadcast send complete..."); } }).start();
				 */
    ...
    public String AddSentMessagetochatandDB(final String message,
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                if ((isgroup == 2) && (check_box.isChecked())
                        && sent_success.equalsIgnoreCase("1")) {// sent success
                    // mean sender
                    // user is
                    // online in
                    // case get sent
                    ...
                    String expirytime = timeInMinutes();

                    message_id = remote_jid + "_" + msgtime;
                    int inApp = broadcastusersid.size()
                            - newbroadcastusersid.size();

                    if (email_check_box.isChecked())
                        mail_count = newMailbroadcastusersid.size();

                    GlobalData.dbHelper.isBroadCastUpdate(stringRowId, "2",
                            inApp + "", newbroadcastusersid.size() + "", mail_count + "",
                            message_id, expirytime);// 25Apl new add
                } else if ((isgroup == 0) && (check_box.isChecked())
                        && sent_success.equalsIgnoreCase("1")) {
                    String expirytime = timeInMinutes();
                    if (email_check_box.isChecked())
                        mail_count = 1;
                    GlobalData.dbHelper.isBroadCastUpdate(stringRowId, "2",
                            0 + "", 1 + "", mail_count + "", message_id, expirytime);// 25Apl new
                    // add
                }
                ...
                getActivity().runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        if ((isgroup == 2) && (check_box.isChecked())
                            ...
                            int inApp = broadcastusersid.size()
                                    - newbroadcastusersid.size();
                            model.setInApMsgCount(inApp);
                            model.setInInboxCount(newbroadcastusersid.size());
                            model.setIsBroadCast(2);

                        } else if ((isgroup == 0) && (check_box.isChecked())
                                && sent_success.equalsIgnoreCase("1")) {

                            model.setInApMsgCount(0);
                            model.setInInboxCount(0);
                            model.setIsBroadCast(2);
                        }
                        ...
                        for (int i = 0; i < broadcastusersid.size(); i++) {
                            ...
                            if (filetype.equals(GlobalData.Locationfile)) {
                                ...
                                GlobalData.dbHelper.addchatFileToMessagetable(
                                        ...
                                        myModel.getRemote_jid(), /* "S" */"R",
                                        "", "", "", msgtime, "", "",
                                        fileIsupload);// set blank
                                if (check_box.isChecked()) {
                                    GlobalData.dbHelper
                                            .updateBroadCast2InFilecase(
                                                    msgtime, jid, "2");// new
                                    // add
                                    // 17may2016
                                }
    ...
    @Override
    public void messagePrint(final String packetId, final String status) {
        String str = "";
        str = packetId;
        ...
        Runnable myRunnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (isgroup == 0) {
                        for (int i = 0; i < chathistorylist.size(); i++) {
                            String packetid = chathistorylist.get(i)
                                    .getMsg_packetid();
                            if (packetid != null)
                                if (packetid.equalsIgnoreCase(packetId)) {

                                    if (status.equals("deliver")) {

                                        chathistorylist.get(i)
                                                .setDeliver_msg_success("1");

										/*
										 * if(packetId!=null&&GlobalData.connection
										 * != null&&
										 * GlobalData.connection.isConnected
										 * ()&&isgroup==0){ MessageEventManager
										 * eventManager=new
										 * MessageEventManager(GlobalData
										 * .connection);
										 * if(eventManager!=null&&packetId
										 * !=null&&packetId.trim().length()>0){
										 * eventManager
										 * .sendDisplayedNotification(remote_jid
										 * ,packetId.trim());
										 * GlobalData.dbHelper
										 * .updatestatusOfSentMessage (
										 * StringUtils
										 * .parseBareAddress(remote_jid),
										 * packetId.trim(),"read"); } }
										 */
                                        ...
                                        chathistorylist.get(i)
                                                .setDeliver_msg_success("1");
                                        chathistorylist.get(i)
                                                .setRead_msg_success("1");
                                    }

                                    chathistorylist.get(i).setIsretry(2);
                                    break;
                                }
                        }
        ...
        // Utils.printLogSMS("messagePrint......");
    ...
    public void inGroupCheckBoxMsgSend(String liveuploadedurlnew,
                                       String packateId, String message_id) {// update message row through
        // message packet id

        sendBroadCastThroughApi(liveuploadedurlnew.trim(), "1", true,
                packateId, message_id);
    }
            ...
            try {
                ...
                if (isgroup == 1) {
                    ...
                    if (chatManager != null) {
                        ...
                        GlobalData.dbHelper.updateFileIsUploadedForRetry(
                                message.getPacketID(), 2);
                        updateAdapterWithIsUpload(message, "");

                        // singleUserCheckBoxMsgSend(liveuploadedurl);
                            ...
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (!GlobalData.dbHelper
                                        ...
                                        contactmodel.setName(phonenumber);
                                        if (!GlobalData.dbHelper
                                                .isOnline(remote_jid)) {
                                            postContactmap.put(
                                                    String.valueOf(0),
                                        ...
                                        if (postContactmap != null
                                                && postContactmap.size() > 0) {

                                            sendBroadCastThroughApi(
                                                    liveuploadedurl.trim(),
                                                    "1", true,
                                                    message.getPacketID(), "");
                    ...
                    if (chatManager != null) {
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String msgtime = Utils.currentTimeStap();
                                final String message_id = remote_jid + "_"
                                        + msgtime;
                                ...
                                for (int i = 0; i < broadcastusersid.size(); i++) {
                                    ...
                                    try {
										 ...
										 * MessageEventManager(GlobalData.connection
										 * );
										 * eventManager.addNotificationsRequests
                                        ...
                                        try {
                                            if (i == 0) {
                                                GlobalData.dbHelper
                                                        .updateFileIsUploadedForRetry(
                                                                message.getPacketID(),
                                                                2);
                                                updateAdapterWithIsUpload(
                                                        message, timeupdate);
                                                GlobalData.dbHelper
                                                        .msgIdUpdateBasePacketId(
                                                                message.getPacketID(),
                                                                message_id);// 25Apl
                                                // new
                                                // add
                                        ...
                                        try {
                                            ...
                                            slcktg = (Slacktags) message
                                                    .getExtension("chattag",
                                                            "mysl:chattag:chat");
                                        ...
                                        org.jivesoftware.smack.packet.Message msg2 = new org.jivesoftware.smack.packet.Message();
                                        msg2.setType(org.jivesoftware.smack.packet.Message.Type.normal);
                                        msg2.setBody(messagebody);
                                        msg2.addExtension(slcktg);
                                        ...
                                        // GlobalData.dbHelper.timeUpdateWithRemoteId(timeupdate,message.getPacketID(),jid);

                                        GlobalData.dbHelper.updateMessageId2(
                                                timeupdate, jid,
                                                msg2.getPacketID(),
                                                message.getPacketID(),
                                                expirytime);
    ...
    public void getLoadMoreMessageHistoryFromServer(String fromTime,
        ...
        if (isgroup == 0) {
            GetSingleUserMessageHistory getSingleUserMessageHistory = new GetSingleUserMessageHistory(
                    inAppMessageActivity, InAppMessageActivity.chatPrefs,
    ...
    public void sendBroadCastThroughApi(String message, String msg_type22,
                                        Boolean status, String packetId, String message_id) {// message type
        // 0 mean
        // text and
        // 1 mean
        // media
        ...
        if (status) {
            ...
            if (isgroup == 2) {
                ...
                for (int j = 0; j < broadcastusersid.size(); j++) {
                    String jid = broadcastusersid.get(j);
                    if (!jid.isEmpty()) {
                        String[] strings = jid.split("@");
                        String phoneNumber = Utils.removeCountryCode(
                                strings[0], getActivity());
                        String timeStap = Utils.currentTimeStap();
                        sms19.inapp.msg.model.PhoneValidModel model = ContactUtil
                                .validNumberForInvite(phoneNumber);
                        if (model != null && model.isNumber()) {
                            Contactmodel contactmodel = new Contactmodel();
                            contactmodel.setNumber(model.getPhone_number());
                            contactmodel.setName(model.getCountry_code()
                                    + model.getPhone_number());
                            contactmodel.setCountry_code(model
                                    .getCountry_code());
                            contactmodel.setMessage_id(model.getPhone_number()
                                    + "_" + timeStap);
                            contactmodel.setMessage_time(timeStap);
                            contactmodel.setRemote_jid(jid);
                            postContactmap.put(String.valueOf(j), contactmodel);
                            if (!GlobalData.dbHelper.isOnline(jid)) {
                                newbroadcastusersid.add(contactmodel);
                                if (GlobalData.dbHelper.isEmailAvailable(jid))
                                    newMailbroadcastusersid.add(contactmodel);
                            }
                        }
                    }
                }

                if (newbroadcastusersid.size() > 0) {
                    String timeStr = timeInMinutes();

                    final int inApp = broadcastusersid.size()
                            - newbroadcastusersid.size();
                    if (check_box.isChecked()) {
                        if (message != null && message.length() <= 2000) {
                            isSmsCreditSelected = true;
                            MessageBroadCastAsyncTask asyncTask = new MessageBroadCastAsyncTask(
                                    inAppMessageActivity,
                                    InAppMessageActivity.chatPrefs, userId,
                                    frndname, remote_jid, message, "0",
                                    msg_type22, timeStr, newbroadcastusersid,
                                    packetId, inApp + "",
                                    newbroadcastusersid.size() + "", message_id);
                            ...
                            Toast.makeText(
                                    getActivity(),
                                    "Message will not delivered as sms. It exceeds more than 2000 character limits",
                                    Toast.LENGTH_LONG).show();
                            check_box.setChecked(false);
                        }
                    }
                    if (email_check_box.isChecked()) {
                        if (!check_box.isChecked()) {
                            isSmsCreditSelected = false;
                        }
                        boolean isEmailTemplateEnabled = false;
                        if (deleteBtn.getVisibility() == View.VISIBLE) {
                            isEmailTemplateEnabled = true;
                        }
                        String timeStrEmail = timeInMinutesEmail();
                        EmailBroadCastAsyncTask asyncTask = new EmailBroadCastAsyncTask(
                                inAppMessageActivity,
                                InAppMessageActivity.chatPrefs, userId,
                                frndname, remote_jid, message, "0", msg_type22,
                                timeStrEmail, newbroadcastusersid, packetId,
                                inApp + "", newbroadcastusersid.size() + "",
                                message_id, isEmailTemplateEnabled, templateId);
                ...
                String timeStap = Utils.currentTimeStap();
                sms19.inapp.msg.model.PhoneValidModel model = ContactUtil
                        .validNumberForInvite(Utils.removeCountryCode(
                                phonenumber, getActivity()));
                if (model != null && model.isNumber()) {
                    Contactmodel contactmodel = new Contactmodel();
                    contactmodel.setNumber(model.getPhone_number());
                    contactmodel.setName(model.getCountry_code()
                            + model.getPhone_number());
                    contactmodel.setCountry_code(model.getCountry_code());
                    contactmodel.setMessage_id(model.getPhone_number() + "_"
                            + timeStap);
                    contactmodel.setMessage_time(timeStap);
                    contactmodel.setRemote_jid(remote_jid);

                    postContactmap.put(String.valueOf(0), contactmodel);

                    if (!GlobalData.dbHelper.isOnline(remote_jid)) {
                        ...
                        if (check_box.isChecked()) {
                            if (message != null && message.length() <= 2000) {
                                ...
                                MessageBroadCastAsyncTask asyncTask = new MessageBroadCastAsyncTask(
                                        ...
                                        frndname, remote_jid, message, "0",
                                        msg_type22, timeStr,
                                        newbroadcastusersid, packetId, "0",
                                        "0", message_id);
                        ...
                        if (email_check_box.isChecked()) {
                            ...
                            EmailBroadCastAsyncTask asyncTask = new EmailBroadCastAsyncTask(
                                    ...
                                    InAppMessageActivity.chatPrefs, userId,
                                    frndname, remote_jid, message, "0",
                                    msg_type22, timeStrEmail,
                                    newbroadcastusersid, packetId, "0", "0",
                                    message_id, isEmailTemplateEnabled,
                                    templateId);
            ...
            if (msg_type22.equalsIgnoreCase("1")) {
                creditDialog("You don't have enough credit balance to send this message and this media file is shared with online users");
            } else if (msg_type22.equalsIgnoreCase("11")) {// sender user is
                // ofline
                creditDialog("You are not login to server, Kindly uncheck the checkbox & resend offline message");
            } else {
                creditDialog("You don't have enough credit balance to send this message, Kindly uncheck the checkbox & resend ");
            }
    ...
    // public synchronized void sendBroadCastAfterEmailUpdateMsg(String
    // message){
    // if (GlobalData.connection.isAuthenticated()) { // 22 Apl2016
    // messageSend(message);
    // } else {
    // messageSendOffline(message, "0");
    // }
    ...
    public synchronized void sendBroadCastAfterUpdateMsg(String message,
                                                         String msg_type22, Boolean status, String packetId,
                                                         String inAppCount, String inInboxCount, String message_id) {// message
        // type
        // 0
        // mean
        // text
        ...
        if (status) {
            ...
            if (isgroup == 2) {
                if (msg_type22.equalsIgnoreCase("0")) {
                    if (GlobalData.connection.isAuthenticated()) { // 22 Apl2016
                        messageSend(message);
                    } else {
                        messageSendOffline(message, "0");
                    }
                } else if (msg_type22.equalsIgnoreCase("1")) {
                    if (GlobalData.connection.isAuthenticated()) {

                        if ((isgroup == 2)
                                && (check_box.isChecked() || email_check_box
                                .isChecked())) {// sent
                            // success
                            // mean
                            // sender
                            ...
                            // GlobalData.dbHelper.isBroadCastUpdateBasePacketId(packetId,"2",
                            // inAppCount+"", inInboxCount+"");// 25Apl new add
                            GlobalData.dbHelper.isBroadCastUpdateBasePacketId(
                                    message_id, "2", inAppCount + "",
                                    inInboxCount + "");// 25Apl new add

                            check_box.setChecked(false);
                            email_check_box.setChecked(false);
                            String messageTime = GlobalData.dbHelper
                                    .getMessageTime(packetId);
                            if (chathistorylist != null
                                    && chathistorylist.size() > 0) {
                                for (int i = 0; i < chathistorylist.size(); i++) {
                                    if (chathistorylist.get(i)
                                            .getBroadCastTime() != null
                                            && chathistorylist.get(i)
                                            .getBroadCastTime()
                                            .length() > 0
                                            && messageTime != null
                                            && (Long.valueOf(chathistorylist
                                            .get(i).getBroadCastTime()
                                            .trim()) == Long
                                            .valueOf((messageTime)))) {
                                        try {
                                            chathistorylist
                                        ...
                                        chathistorylist.get(i)
                                                .setIsBroadCast(2);
                                        chatAdapter
                                                .setChatListArrayList(chathistorylist);
                                        chatAdapter.notifyDataSetChanged();
                                        break;
                                    }
                                }
                ...
                if (model != null && model.isNumber()) {
                    ...
                    contactmodel.setNumber(model.getCountry_code()
                            + model.getPhone_number());

                    contactmodel.setCountry_code(model.getCountry_code());
                    contactmodel.setName(model.getPhone_number());
                    contactmodel.setRemote_jid(remote_jid);
                    postContactmap.put(String.valueOf(0), contactmodel);

                    // String contactstring =
                    // Utils.makeJsonarrayfromContactmap(postContactmap);
                    ...
                    if (!GlobalData.dbHelper.isOnline(remote_jid)) {
                        ...
                        if (msg_type22.equalsIgnoreCase("0")) {
                            if (GlobalData.connection.isAuthenticated()) { // 22
                                // Apl2016
                                messageSend(message);
                            } else {
                                messageSendOffline(message, "0");
                            ...
                            if (GlobalData.connection.isAuthenticated()) {
                                ...
                                if ((isgroup == 2)
                                    ...
                                    // ArrayList<Chatmodel>
                                    // chatList=chatAdapter.getChatArrayList();

                                    if (chathistorylist != null
                                            && chathistorylist.size() > 0) {
                                        for (int i = 0; i < chathistorylist
                                                .size(); i++) {
                                            if (chathistorylist.get(i)
                                                    .getBroadCastTime() != null
                                                    && chathistorylist.get(i)
    ...
    private class ShareFtpData extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(getActivity(), "Data has been shared",
                    Toast.LENGTH_LONG).show();
          /*  mMessageEdtext.setText(fileName + " shared");
            sendButtonAction();*/
        }
    }
...
if (v == mSpamReportBtn) {
        ...
        if (v == email_time_select) {
        }
        if (v == mBlockBtn) {

        }

        if (v.getId() == R.id.fc_addpreviousmsg) {
        }
...
//			setEmojiconFragment(false);
    ...
    public ImageView getBack_on_search() {
        return back_on_search;
    }

    public EditText getmSearchEdt() {
        return mSearchEdt;
    }
        ...
        public MultiChoiceCallback(ListView view) {
            usingView = view;
        }
        ...
        public void onItemCheckedStateChanged(ActionMode mode, int position,
            ...
            if (checked) {
                ...
                // selectedItem.put(String.valueOf(position),
            ...
            if (checkedCount == 0) {
                ...
                inAppMessageActivity.actionBarHide();
                inAppMessageActivity.getLayoutTab_contact_chat().setVisibility(
                        View.GONE);
            }
    ...
    // public void uploadAndSendSelectedfile1(final String path,
    // final String filetype) {
    //
    // new Thread(new Runnable() {
    //
    ...
    // http://test.kitever.com/NewService.aspx?Page=
    // File uploadFile = new File(path);//
    // /storage/sdcard0/Kitever/Media/Kitever Images/Kitever_1472482910785.jpg
    // final String[] img = path.split("/");// [, storage, sdcard0, Kitever,
    // Media, Kitever Images, Kitever_1472482910785.jpg]
    // String imgname = "";
    // imgname = img[img.length - 1];// Kitever_1472482910785.jpg
    // try {
    ...
    // org.jivesoftware.smack.packet.Message messageNew = null;
    // String
    // msg="file__http://nowconnect.in/"+userId+"/"+imgname+"__"+filetype;
    // if (false) {//isRetry
    // messageNew = onRetryFileUpload(msg, chatmodel);
    // } else {
    // messageNew = sendMessageBeforeUpload(msg, remote_jid,
    // path, filetype);
    // }
    // MyTransferListener listener = new MyTransferListener(messageNew,
    // null, "http://nowconnect.in/"+userId + "/" + imgname, ischecked);
    // listener.completed();
    // }catch(Exception e){
    //
    // }
...
/*
	 ...
	 * RESULT_LOAD_IMAGE && resultCode == getActivity().RESULT_OK) {
	 *
	 * String uri = "";
	 *
	 * String picpath = uri;
	 ...
	 *
	 * int columnIndex = cursor.getColumnIndex(filePathColumn[0]); picpath =
	 * cursor.getString(columnIndex); cursor.close(); loadimage(picpath);
	 *
	 *
	 *
	 * } else if (requestCode == CAMERA_REQUEST&& resultCode ==
	 * getActivity().RESULT_OK) {
	 *
	 * String[] filePathColumn = { MediaStore.Images.Media.DATA }; Cursor cursor
	 * = getActivity().getContentResolver().query(mCapturedImageURI,
	 * filePathColumn, null, null, null); cursor.moveToFirst(); int column_index
	 * = cursor.getColumnIndex(filePathColumn[0]);
	 *
	 * String picpath = cursor.getString(column_index); cursor.close(); Bitmap
	 * finalBitmap = Utils.decodeFile(picpath, GlobalData.fileorignalWidth,
	 * GlobalData.fileorignalheight);
	 *
	 *
	 * try { String savedpicpath = Utils.getfilePath(GlobalData.Imagefile);
	 * FileOutputStream fos = new FileOutputStream(savedpicpath);
	 *
	 * finalBitmap.compress(CompressFormat.JPEG, 80, fos);
	 *
	 * fos.close(); if (finalBitmap != null) { finalBitmap.recycle(); } if
	 * (savedpicpath != null && savedpicpath.trim().length() != 0) { fileType =
	 * GlobalData.Imagefile;
	 *
	 * loadimage(savedpicpath); }
	 *
	 *
	 *
	 *
	 ...
	 *
	 * } else if (requestCode == VIDEO_REQUEST && resultCode ==
	 * getActivity().RESULT_OK) {
	 *
	 * if (videoPath != null && videoPath.trim().length() != 0) {
	 * sendVideofile(videoPath); }
	 ...
	 * public boolean hasPermission(String permission) {
     ...
     public void downloadImage(final String url) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String pathnew = Utils.getProfilePath();
                try {
                    ...
                    BufferedInputStream inStream = new BufferedInputStream(is,
                            1024 * 5);
                    FileOutputStream outStream = new FileOutputStream(pathnew);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            bmBef = BitmapFactory.decodeFile(pathnew, bmo);
                    ...
                    new File((GlobalData.FTP_HOST + Utils
                            .getProfilePathForGroupImagwDownload(frndname)))
                            .delete();
                    e.printStackTrace();
     ...
     public TextView getuser_email_creadit() {
        return user_email_creadit;
    }
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (items1[item].equals("Choose Existing")) {
                    ...
                    if (isSDPresent) {
                        ...
                        Toast.makeText(getActivity(), "No SD card sorry!",
                                Toast.LENGTH_SHORT).show();
                    }
                }
